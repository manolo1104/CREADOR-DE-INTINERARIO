...
export const alt         = `${DESTINOS_DB.length} Destinos — Cascadas, Cañones & Arte | Huasteca Potosina`;
  ...
  return new ImageResponse(
    <div
      style={{
        ...
        background: "linear-gradient(140deg, #0e1e0e 0%, #1a3a0e 60%, #2a4a1a 100%)",
        padding: "60px",
      }}
    >
      ...
      <div style={{ display: "flex", gap: "16px", flexWrap: "wrap", justifyContent: "center" }}>
        {["Cascadas turquesas", "Cañones kársticos", "Jardines surrealistas", "Arqueología"].map((t) => (
          <span key={t} style={{
