    ...
    <main className="bg-tinta text-hielo md:pt-[52px]">
      ...
      {!yaAbrio && (
        <div className="border-b border-azul/40 bg-azul-humo px-5 py-4">
          <div className="mx-auto flex max-w-6xl flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <a
              href="/curso/webinar"
              className="inline-block shrink-0 whitespace-nowrap bg-azul px-6 py-3.5 text-center font-dm text-[13px] font-semibold uppercase tracking-[1px] text-tinta transition-transform duration-200 ease-out active:scale-[0.98]"
            >
              Ir al taller gratis
            </a>
          </div>
      ...
      <section className="mx-auto grid max-w-6xl items-center gap-10 px-5 pb-14 pt-10 md:grid-cols-[7fr_5fr] md:gap-14 md:pb-20 md:pt-16">
        <div>
          ...
          <h1 className="mt-4 font-sora text-[2.6rem] font-semibold leading-[1.04] text-hielo sm:text-6xl md:text-[4.2rem]">
            +{mxnCurso(CIFRAS.total4m)} en 4 meses.
            <br />
            <em className="not-italic text-azul-vivo">Sin pagar publicidad.</em>
          </h1>
          <p className="mt-6 max-w-[32ch] font-dm text-xl leading-relaxed text-hielo/80 sm:text-2xl">
          ...
          <div className="mt-8 flex flex-col gap-4 sm:flex-row sm:items-center">
            ...
            <a
              href="#programa"
              className="inline-block whitespace-nowrap border border-azul/40 px-6 py-5 text-center font-dm text-[14px] uppercase tracking-[1px] text-azul-vivo sm:text-base sm:tracking-[2px] sm:px-8 transition-colors duration-200 hover:border-azul hover:bg-azul-humo"
            >
              Ver el programa
            </a>
          </div>
        ...
        <figure className="relative">
          <div className="relative aspect-[4/5] w-full overflow-hidden border border-linea bg-tinta-2 shadow-[0_24px_60px_-24px_rgba(0,0,0,0.9)] sm:aspect-[4/3] md:aspect-[4/5]">
            <Image
      ...
      <section className="bg-tinta-2 px-5 py-14 text-hielo md:py-16">
        <div className="mx-auto grid max-w-5xl gap-10 text-center sm:grid-cols-3 sm:gap-6">
          <div>
            <Cifra hasta={CIFRAS.toursVentas4m} prefijo="+$" className="font-sora text-5xl font-semibold text-azul-vivo md:text-6xl" />
          ...
          <div>
            <Cifra hasta={CIFRAS.hotelReservas4m} prefijo="+$" className="font-sora text-5xl font-semibold text-azul-vivo md:text-6xl" />
            <p className="mt-3 font-dm text-base leading-snug opacity-85">
              en reservas del hotel<br />en sus primeros 4 meses
            </p>
          </div>
          <div>
            <span className="font-sora text-5xl font-semibold text-azul-vivo md:text-6xl">$0</span>
            <p className="mt-3 font-dm text-base leading-snug opacity-85">
              en publicidad pagada. El único gasto:<br />la suscripción de IA
            </p>
          </div>
        </div>
        <div className="mx-auto mt-10 max-w-5xl border-t border-linea pt-6 text-center">
          ...
          <p className="mt-3 font-dm text-base font-medium text-azul-vivo">
      ...
      <section className="mx-auto max-w-5xl px-5 py-16 md:py-24">
        ...
        <div className="mt-10 grid gap-x-12 gap-y-8 md:grid-cols-2">
          {DOLORES.map((d) => (
            <blockquote key={d} className="border-l-2 border-azul pl-6">
              <p className="font-sora text-2xl italic leading-snug text-hielo/85 md:text-[1.7rem]">
                “{d}”
              </p>
            </blockquote>
          ))}
        </div>
        <p className="mt-10 max-w-[58ch] font-dm text-lg leading-relaxed text-hielo/75">
      ...
      <section className="bg-tinta-2 px-5 py-16 text-hielo md:py-24">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-8 grid gap-12 md:grid-cols-[3fr_2fr] md:gap-16">
            ...
            <dl className="h-fit border border-linea bg-tinta-3 p-7 font-dm">
              <div className="flex items-baseline justify-between gap-4 py-3">
                <dt className="text-base opacity-80">Publicidad pagada</dt>
                <dd className="text-2xl font-semibold text-azul-vivo">$0</dd>
              </div>
              <div className="flex items-baseline justify-between gap-4 border-t border-linea py-3">
                <dt className="text-base opacity-80">Suscripción de IA</dt>
                <dd className="text-right text-base font-medium text-hielo">cientos de pesos/mes</dd>
              </div>
              <div className="flex items-baseline justify-between gap-4 border-t border-linea py-3">
                <dt className="text-base opacity-80">Ventas + reservas</dt>
                <dd className="text-2xl font-semibold text-azul-vivo">+{mxnCurso(CIFRAS.total4m)}</dd>
              </div>
              <p className="mt-2 border-t border-linea pt-4 text-sm leading-relaxed opacity-70">
          ...
          <div className="mt-14 grid gap-6 sm:grid-cols-3">
            {[
              ...
              <figure key={f.src + f.pie}>
                <div className="relative aspect-[3/4] overflow-hidden border border-linea bg-tinta-3">
        ...
        <ol className="mt-12 space-y-0">
          {PROGRAMA.map((s, i) => (
            <li key={s.semana} className={`grid gap-5 py-9 sm:grid-cols-[auto_1fr] sm:gap-8 ${i > 0 ? "border-t border-linea" : ""}`}>
              ...
              <div>
                <h3 className="font-sora text-3xl font-semibold leading-tight text-hielo">
                  {s.titulo}
                </h3>
                <ul className="mt-4 space-y-2.5">
                  {s.sesiones.map((t) => (
                    <li key={t} className="flex gap-3 font-dm text-lg leading-relaxed text-hielo/80">
                      <span aria-hidden="true" className="mt-[13px] h-1.5 w-1.5 shrink-0 bg-azul" />
                      {t}
                    </li>
                  ))}
                </ul>
      ...
      <section className="bg-[#efe8d3] px-5 py-16 md:py-24">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mt-10">
            <div className="hidden grid-cols-2 gap-8 pb-3 font-dm text-sm font-semibold uppercase tracking-[2px] text-hielo/50 sm:grid">
              <span>Hoy</span>
              <span className="text-azul-vivo">En 4 semanas</span>
            </div>
            {ANTES_DESPUES.map(([antes, despues], i) => (
              <div key={antes} className={`grid gap-2 py-6 sm:grid-cols-2 sm:gap-8 ${i > 0 ? "border-t border-linea" : "sm:border-t sm:border-linea"}`}>
                <p className="font-dm text-lg leading-relaxed text-hielo/60">
                  <span className="mr-2 font-semibold uppercase tracking-wide text-hielo/40 sm:hidden">Hoy:</span>
                  {antes}
                </p>
                <p className="font-dm text-lg font-medium leading-relaxed text-hielo">
                  <span className="mr-2 font-semibold uppercase tracking-wide text-azul-vivo sm:hidden">Después:</span>
                  {despues}
                </p>
              </div>
            ))}
      ...
      <section className="mx-auto max-w-4xl px-5 py-16 md:py-24">
        ...
        <ul className="mt-8 space-y-4">
          {INCLUYE.map((x) => (
            <li key={x} className="flex items-start gap-4 font-dm text-lg leading-relaxed text-hielo/85">
              <svg aria-hidden="true" className="mt-1.5 h-5 w-5 shrink-0 text-azul-vivo" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M20 6 9 17l-5-5" /></svg>
              {x}
            </li>
          ))}
        </ul>
        ...
        <div className="mt-14">
          <h3 className="font-sora text-3xl font-semibold text-hielo">
            Y si entras con precio de fundador, también:
          </h3>
          <div className="mt-6 space-y-4">
            {BONOS.map((b, i) => (
              <div key={b.nombre} className="border border-azul/50 bg-tinta-2 p-6 sm:flex sm:items-start sm:justify-between sm:gap-8">
                <div>
                  <p className="font-dm text-sm font-semibold uppercase tracking-[2px] text-azul-vivo">
                    Bono {i + 1}
                  </p>
                  <h4 className="mt-1 font-sora text-2xl font-semibold leading-tight text-hielo">
                    {b.nombre}
                  </h4>
                  <p className="mt-2 max-w-[52ch] font-dm text-base leading-relaxed text-hielo/75">{b.detalle}</p>
                </div>
                <p className="mt-4 shrink-0 font-dm text-lg font-semibold text-hielo sm:mt-1 sm:text-right">
                  Valor: {mxnCurso(b.valor)}
                  <span className="block text-sm font-medium text-azul-vivo">incluido</span>
                </p>
              </div>
            ))}
          </div>
          <p className="mt-5 font-dm text-base text-hielo/70">
      ...
      <section id="inversion" className="scroll-mt-16 bg-tinta-2 px-5 py-16 text-hielo md:py-24">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <div className="mt-10 border border-linea bg-tinta-3 p-8 md:p-12">
            {pv.esFundador ? (
              <>
                <p className="font-dm text-sm font-semibold uppercase tracking-[2.5px] text-azul-vivo">
                  Precio de fundador
                </p>
                <p className="mt-4 font-dm text-xl text-hielo/60">
                  <s>{mxnCurso(PRECIOS.regular)}</s>
                </p>
                <p className="font-sora text-7xl font-semibold text-hielo md:text-8xl">
                  {mxnCurso(PRECIOS.fundador)}
                </p>
                <p className="mt-3 font-dm text-lg text-hielo/85">
              ...
              <>
                ...
                <p className="mt-4 font-sora text-7xl font-semibold text-hielo md:text-8xl">
          ...
          <div className="mx-auto mt-10 max-w-[60ch] space-y-4 text-left font-dm text-lg leading-relaxed text-hielo/85">
            <p>
              Piénsalo contra lo que reemplaza: la página que pagas por fuera,
              el asistente que contesta y el CRM suman más de{" "}
              <strong className="text-hielo">{mxnCurso(CIFRAS.reemplazaAnualMxn)} al año</strong>.
            </p>
            <p>
              Y contra lo que produce: este sistema generó más de{" "}
              <strong className="text-hielo">{mxnCurso(CIFRAS.total4m)} en 4 meses</strong> en
          ...
          <div className="mt-10 border border-linea bg-tinta-3 p-7 text-left sm:flex sm:items-start sm:gap-5">
            <svg aria-hidden="true" className="h-9 w-9 shrink-0 text-azul-vivo" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z" /><path d="m9 12 2 2 4-4" /></svg>
            <div className="mt-3 sm:mt-0">
              <h3 className="font-sora text-2xl font-semibold text-hielo">{GARANTIA.nombre}</h3>
              <p className="mt-2 font-dm text-base leading-relaxed text-hielo/85">{GARANTIA.texto}</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-5 py-16 md:py-24">
        ...
        <div className="mt-10 grid gap-10 md:grid-cols-2">
          <div>
            <h3 className="font-dm text-base font-semibold uppercase tracking-[2px] text-azul-vivo">
              Sí, si eres
            </h3>
            <ul className="mt-5 space-y-3.5">
              {PARA_QUIEN.map((x) => (
                <li key={x} className="flex items-start gap-3.5 font-dm text-lg leading-relaxed text-hielo/85">
                  <svg aria-hidden="true" className="mt-1.5 h-5 w-5 shrink-0 text-azul-vivo" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M20 6 9 17l-5-5" /></svg>
                  {x}
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="mt-5 space-y-3.5">
              {NO_ES_PARA.map((x) => (
                <li key={x} className="flex items-start gap-3.5 font-dm text-lg leading-relaxed text-hielo/70">
                  <svg aria-hidden="true" className="mt-1.5 h-5 w-5 shrink-0 text-azul-vivo" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round"><path d="M18 6 6 18M6 6l12 12" /></svg>
                  {x}
                </li>
              ))}
            </ul>
      ...
      <section className="bg-[#efe8d3] px-5 py-16 md:py-24">
        <div className="mx-auto max-w-3xl">
          ...
          <div className="mt-8">
            {FAQS.map((f) => (
              <details key={f.p} className="group border-t border-linea py-1 last-of-type:border-b">
                <summary className="flex cursor-pointer list-none items-center justify-between gap-4 py-5 font-dm text-lg font-medium text-hielo [&::-webkit-details-marker]:hidden">
                  {f.p}
                  <svg aria-hidden="true" className="h-5 w-5 shrink-0 text-azul-vivo transition-transform duration-200 ease-out group-open:rotate-45" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><path d="M12 5v14M5 12h14" /></svg>
                </summary>
                <p className="max-w-[60ch] pb-6 font-dm text-lg leading-relaxed text-hielo/75">{f.r}</p>
              </details>
            ))}
          </div>
          <div className="mt-10 border border-azul/25 bg-tinta-2 p-7 text-center">
            <p className="font-dm text-lg text-hielo/85">¿Tienes otra duda? Pregúntame directo, te contesto yo.</p>
            <a
              href={WHATSAPP_CURSO}
              target="_blank"
              rel="noopener noreferrer"
              className="mt-4 inline-flex items-center gap-2.5 bg-[#25d366] px-8 py-4 font-dm text-base font-semibold uppercase tracking-[1.5px] text-hielo transition-transform duration-150 ease-out active:scale-[0.98]"
            >
      ...
      {/* ══ CIERRE ══ */}
      <section id="cierre" className="scroll-mt-16 bg-tinta-2 px-5 py-16 text-hielo md:py-24">
        <div className="mx-auto max-w-3xl text-center">
          ...
          {pagados >= 3 && (
            <div className="mx-auto mt-8 max-w-md">
              <div className="h-2.5 w-full border border-linea">
                <div
                  className="h-full bg-azul"
                  style={{ width: `${Math.min(100, Math.round((pagados / PRECIOS.cupoTotal) * 100))}%` }}
                />
              </div>
              <p className="mt-2.5 font-dm text-base text-hielo/80">
          ...
          <div className="mt-16 border-t border-linea pt-12 text-left">
            <h3 className="text-center font-sora text-3xl font-semibold">
              ¿Aún no te decides?
            </h3>
            <p className="mx-auto mt-3 max-w-[48ch] text-center font-dm text-lg leading-relaxed text-hielo/80">
              Déjame tus datos y te mando el programa completo por correo, sin
              compromiso.
            </p>
            <div className="mx-auto mt-8 max-w-xl border border-linea bg-tinta p-6 text-hielo sm:p-8">
              <FormLead />
            </div>
          </div>
        </div>
      ...
      {/* ══ PIE MÍNIMO ══ */}
      <footer className="bg-tinta-2 px-5 py-10 pb-24 text-center font-dm text-sm text-hielo/60 md:pb-10">
        <p>
        ...
        <p className="mt-3 space-x-4">
          ...
          <a href={WHATSAPP_CURSO} target="_blank" rel="noopener noreferrer" className="underline hover:text-hielo">WhatsApp</a>
        </p>
      </footer>
    </main>
  );
