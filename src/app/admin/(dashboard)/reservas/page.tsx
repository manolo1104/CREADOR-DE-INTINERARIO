...
export default async function ReservasPage() {
  ...
  const [bookings, evidencias, presetsExtras] = await Promise.all([
  ...
  return <ReservasClient initialBookings={bookings} initialEvidencias={evidencias} presetsExtras={presetsExtras} />;
}
