...
export const DESTINOS_EN: Record<string, DestinoTranslation> = {
  "las-pozas-jardin-surrealista": {
    ...
    como_llegar: "1h 45min from Ciudad Valles · Taxi $1,200 MXN · Bus $110 MXN",
  ...
  "zona-arqueologica-tamohi-el-consuelo": {
    ...
    tipo: "Archaeology",
    precio_entrada: "Free admission (video camera use $45 MXN)",
    dias_abierto: "Monday to Sunday",
    mejor_hora: "09:00 AM",
    temporada_ideal: "Nov–Mar",
  ...
  "la-trinidad-xilitla": {
    ...
    datos_curiosos: [
      ...
      "There are wooden cabins for couples and groups (roughly $700 to $2,500 MXN), a camping area, fire pits and grills where you can cook your own food.",
  ...
  "cueva-del-salitre": {
    ...
    seo: {
      ...
      metaDescription: "Cueva del Salitre, a hidden gem of Xilitla: ~100 m wide and 300 m deep, with caving, rappelling and five climbing routes. How to get there, $50 MXN fee and tips.",
