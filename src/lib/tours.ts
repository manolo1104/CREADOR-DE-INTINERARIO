...
export const TOURS_DB: Tour[] = [
  ...
  },
  {
    ...
    imagen_hero: "/imagenes/tours/ruta-surrealista-hero.webp",
    imagenes: [
      "/imagenes/tours/ruta-surrealista-hero.webp",
      "/imagenes/xilitla-pueblo-magico/hero.jpg",
    ],
    gallery: [
      { src: "/imagenes/tours/ruta-surrealista-hero.webp",           alt: "Jardín Surrealista de Edward James — Las Pozas de Xilitla" },
