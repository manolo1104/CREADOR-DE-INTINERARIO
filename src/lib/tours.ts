...
export const TOURS_DB: Tour[] = [
  {
    ...
    imagen_hero: "/imagenes/tours/tamul/hero.png",
    imagenes: [
      "/imagenes/tours/tamul/hero.png",
      "/imagenes/tours/tamul/gallery-5.png",
    ],
    gallery: [
      { src: "/imagenes/tours/tamul/hero.png",      alt: "Vista de la Cascada de Tamul desde el cañón — turistas con chalecos", hasRealPeople: true },
      { src: "/imagenes/tours/tamul/gallery-1.png", alt: "Cueva del Agua — haces de luz sobre el cenote turquesa subterráneo", hasRealPeople: true },
      { src: "/imagenes/tours/tamul/gallery-2.png", alt: "Clavado desde las piedras en el Cañón del Tampaón", hasRealPeople: true },
      { src: "/imagenes/tours/tamul/gallery-3.png", alt: "Canoa feliz en el Cañón del Tampaón — la Cascada de Tamul al fondo", hasRealPeople: true },
      { src: "/imagenes/tours/tamul/gallery-4.png", alt: "Guerra de agua entre canoas en el río Tampaón", hasRealPeople: true },
      { src: "/imagenes/tours/tamul/gallery-5.png", alt: "Sótano de las Huahuas — miles de pericos emergiendo en espiral al amanecer" },
      { src: "/imagenes/tours/tamul/gallery-6.png", alt: "Asomándose al borde del Sótano de las Huahuas — 512 metros de profundidad", hasRealPeople: true },
    ],
  },
  {
    ...
    imagen_hero: "/imagenes/tours/edward-james/hero.png",
    imagenes: [
      "/imagenes/tours/edward-james/hero.png",
      "/imagenes/tours/edward-james/gallery-1.png",
    ],
    gallery: [
      { src: "/imagenes/tours/edward-james/gallery-1.png",  alt: "Escultura surrealista de Edward James — color y musgo en Las Pozas de Xilitla", hasRealPeople: true },
      { src: "/imagenes/tours/edward-james/gallery-2.png",  alt: "Torres de concreto de Las Pozas emergiendo entre la selva con cielo azul" },
      { src: "/imagenes/tours/edward-james/gallery-3.png",  alt: "Pareja en el Castillo de la Salud — arquitectura colorida de Tamul", hasRealPeople: true },
      { src: "/imagenes/tours/edward-james/gallery-4.png",  alt: "Poza turquesa del Nacimiento de Huichihuayán con rayos de luz natural" },
      { src: "/imagenes/tours/edward-james/gallery-5.png",  alt: "Portal circular de Las Pozas — sendero de adoquín entre helechos y selva" },
      { src: "/imagenes/tours/edward-james/gallery-6.png",  alt: "Interior de la Cueva de las Quilas — hombre admirando la formación rocosa", hasRealPeople: true },
      { src: "/imagenes/tours/edward-james/gallery-7.png",  alt: "Castillo de la Salud — vista aérea de torres coloridas entre selva huasteca" },
      { src: "/imagenes/tours/edward-james/gallery-8.png",  alt: "Estructura principal de Las Pozas rodeada de vegetación exuberante" },
      { src: "/imagenes/tours/edward-james/gallery-9.png",  alt: "Cañón oscuro con luz entrando desde arriba — Cueva de las Quilas", hasRealPeople: true },
      { src: "/imagenes/tours/edward-james/gallery-10.png", alt: "Río turquesa del Nacimiento de Huichihuayán entre piedras y selva verde" },
    ],
  },
  {
    id:               "tour-meco",
    ...
    imagen_hero: "/imagenes/tours/cascada-meco-hero.jpg",
    imagenes: ["/imagenes/tours/cascada-meco-hero.jpg"],
    gallery: [
      { src: "/imagenes/tours/cascada-meco-hero.jpg",    alt: "Cascada del Meco — pozas turquesas con luz perfecta de la mañana" },
      { src: "/imagenes/cascada-el-salto/hero.jpg",      alt: "Cascada del Salto — 40 metros de caída libre en la Huasteca" },
      { src: "/imagenes/cascada-el-meco/gallery-1.jpg",  alt: "Detalle de las pozas turquesas de la Cascada del Meco" },
